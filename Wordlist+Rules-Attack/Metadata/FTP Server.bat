...
Echo  1. FileZilla Server ">" 0.9.55
Echo  2. Back
...
:1
cls
..\Hashcat\hashcat64.exe -m 15000 -a 0 --outfile=..\Output\output.txt --outfile-format=2 ..\Input\hashes.txt .\Wordlist\wordlist.txt -r ".\Rule\rules.rule" || (echo Error && timeout 10 && exit)
timeout 10
